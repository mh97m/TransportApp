            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                <div class="card" style="border-radius: 10px; box-shadow: 0px 0px 7px rgba(0, 0, 0, 0.342);">
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex flex-column align-items-center position-relative mb-3">
                            ...
                            <div class="text-center">
                                <div class="small text-muted my-1">{{ $order->cargo->distance }} کیلومتر</div>
                            </div>
                            ...
                            <div class="w-100 position-relative mb-3" style="height: 14px; width: 70% !important;">
                                <div class="position-absolute w-100 d-flex align-items-center">
                                    ...
                                    {{-- <svg width="100%" height="50" viewBox="0 0 250 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <!-- Road Background -->
                                        <rect x="0" y="15" class="w-100" height="20" fill="#4e4e4ec9"/>
                                        ...
                                        <line x1="40" y1="25" x2="50" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="60" y1="25" x2="70" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="80" y1="25" x2="90" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="100" y1="25" x2="110" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="120" y1="25" x2="130" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="140" y1="25" x2="150" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="160" y1="25" x2="170" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="180" y1="25" x2="190" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="200" y1="25" x2="210" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="220" y1="25" x2="230" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="240" y1="25" x2="250" y2="25" stroke="white" stroke-width="2"/>

                                        <!-- Arrow at Destination -->
                                        <path d="M 10 22 L 10 28 L 0 25 Z" fill="white"/>
                                    </svg>
                                    ...
                                    <svg width="100%" height="50" viewBox="0 0 250 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <!-- Road Background -->
                                        <rect x="0" y="15" width="100%" height="20" fill="#4e4e4ec9"/>
                                    
                                        <!-- Road Lane Markings (Dashes) -->
                                        <line x1="10" y1="25" x2="20" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="30" y1="25" x2="40" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="50" y1="25" x2="60" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="70" y1="25" x2="80" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="90" y1="25" x2="100" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="110" y1="25" x2="120" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="130" y1="25" x2="140" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="150" y1="25" x2="160" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="170" y1="25" x2="180" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="190" y1="25" x2="200" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="210" y1="25" x2="220" y2="25" stroke="white" stroke-width="2"/>
                                        <line x1="230" y1="25" x2="240" y2="25" stroke="white" stroke-width="2"/>
                            ...
                            <div class="row col-12 d-flex justify-content-between w-100 h4">
                                ...
                                <div class="col-4 text-center">
                                    <h5 class="font-weight-bold mb-0">{{ $order->cargo->originProvince->title }}</h5>
                                    <small class="text-muted">{{ $order->cargo->originCity->title }}</small>
                                </div>

                                <!-- Destination -->
                                <div class="col-4 text-center">
                                    <h5 class="font-weight-bold mb-0">{{ $order->cargo->destinationProvince->title }}</h5>
                                    <small class="text-muted">{{ $order->cargo->destinationCity->title }}</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-muted mt-3">
                            ...
                            <span class="pr-3"><i class="fas fa-truck fa-lg"></i> <strong>ماشین:</strong> {{ $order->cargo->carType->title }}</span>
                            <span class="pl-3"><i class="fas fa-box fa-lg"></i> <strong>باربر:</strong> {{ $order->cargo->loaderType->title }}</span>
                        </p> --}}
                            ...
                            <p class="mb-2 pt-2 h4 d-flex justify-content-start align-items-center">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2">
                                    <g id="group">
                                        <path id="Vector" d="M12 2C10.9 2 10 2.9 10 4V14C8.34 14 7 15.34 7 17C7 18.66 8.34 20 10 20H14C15.66 20 17 18.66 17 17C17 15.34 15.66 14 14 14V4C14 2.9 13.1 2 12 2Z" stroke="#598bc4cf" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path id="Vector_2" d="M12 6V14" stroke="#598bc4cf" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path id="Vector_3" d="M12 17C11.4477 17 11 16.5523 11 16C11 15.4477 11.4477 15 12 15C12.5523 15 13 15.4477 13 16C13 16.5523 12.5523 17 12 17Z" fill="#598bc4cf"></path>
                                    </g>
                                </svg>
                                {{ $order->cargo->weight }} درجه
                            </p>
                            <p class="mb-2 pt-2 h4 d-flex justify-content-start align-items-center">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="mr-2">
                                    <g id="group">
                                        <path id="Vector"
                                            ...
                                            stroke="#598bc4cf" stroke-width="1.5" stroke-linecap="round"
                                ...
                                {{ $order->cargo->carType->title }} {{ $order->cargo->loaderType->title }}
                            </p>
                            <p class="mb-2 pt-2 h4 d-flex justify-content-start align-items-center">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="mr-2">
                        ...
                        <div class="row mt-4 text-center">
                            <div class="col-12">
                                <h4 class="text-black" style="font-size: 22px;">
                                    <i class="fas fa-coins text-success fa-lg h4"></i> {{ number_format($order->cargo->price) }} تومان
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div
                            class="alert alert-{{ $order->status->color }} col-10 mb-0 mb-4 text-center"
                        >
                            {{ $order->status->description }}
                        </div>
                    </div>

                    <a href="tel:{{ $order->cargo->mobile }}"
